...
public class FBO_old implements MemoryManaged {
	...
	// TODO: Should I be referencing an ID and grabbing it through GLFW methods?
	 ...
	 *            this FBO should use.
	 */
	public FBO_old(int width, int height, int depthBufferType, Window window) {
		this.width = width;
		this.height = height;
		this.window = window;
	...
	public FBO_old(int width, int height, Window window) {
		this.width = width;
		this.height = height;
		this.window = window;
	...
	public void resolveToFbo(int readBuffer, FBO_old outputFbo) {
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, window.getWidth(), window.getHeight(), GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
